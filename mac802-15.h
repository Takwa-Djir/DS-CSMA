...
public:
	...
	inline u_int32_t getHdrLen11() {
		return(getPLCPhdrLen() + offsetof(struct hdr_mac802_15, dh_body[0])
                       + ETHER_FCS_LEN);
	}
...
private:
	...
	CSSA_BackoffTimer mhCSSA_Backoff_; // CSSA_backoff timer
